## API Report File for "@playchi-js/playchi-js"
...
// Warning: (ae-forgotten-export) The symbol "PCAutoPlayTypes" needs to be exported by the entry point playchi.d.ts
//
// @public (undocumented)
export const AutoPlayType: PCAutoPlayTypes;
...
export class BaseMediaSourceAdapter extends FakeEventTarget implements IMediaSourceAdapter {
    ...
    get capabilities(): PCMediaSourceCapabilities;
    protected _capabilities: PCMediaSourceCapabilities;
...
// @public
export function createTextTrackCue(timedMetadata: TimedMetadata): PCTextTrackCue | null;
...
// Warning: (ae-forgotten-export) The symbol "IEnv" needs to be exported by the entry point playchi.d.ts
//
// @public (undocumented)
...
class Error_2 {
    ...
    // Warning: (ae-forgotten-export) The symbol "CategoryType" needs to be exported by the entry point playchi.d.ts
    static Category: CategoryType;
    // (undocumented)
    category: number;
    // Warning: (ae-forgotten-export) The symbol "CodeType" needs to be exported by the entry point playchi.d.ts
    ...
    // (undocumented)
    errorDetails: any;
    // Warning: (ae-forgotten-export) The symbol "SeverityType" needs to be exported by the entry point playchi.d.ts
...
export class EventManager {
    ...
    // Warning: (ae-forgotten-export) The symbol "ListenerType" needs to be exported by the entry point playchi.d.ts
...
// @public (undocumented)
export const EventType: PCEventTypes;
...
export class FakeEventTarget {
    constructor();
    // Warning: (ae-forgotten-export) The symbol "EventListener_2" needs to be exported by the entry point playchi.d.ts
    //
    // @override
...
// @public
export function filterTracksByRestriction(videoTracks: VideoTrack[], restriction: PCABRRestrictionObject): VideoTrack[];
...
// Warning: (ae-forgotten-export) The symbol "PCMediaTypes" needs to be exported by the entry point playchi.d.ts
//
// @public (undocumented)
export const MediaType: PCMediaTypes;

// @public (undocumented)
const MimeType_2: PCMimeTypes;
...
// @public (undocumented)
export type PCExternalThumbnailsConfig = {
    vttUrl: string;
};
...
// @public (undocumented)
export type PCMediaSourceCapabilities = {
...
// @public (undocumented)
export type PCMediaSourceOptionsObject = {
...
// @public (undocumented)
export type PCPlayOptionsObject = {
    programmatic: boolean;
};

// @public (undocumented)
export type PCPreferNativeConfigObject = {
    hls: boolean;
    dash: boolean;
};
...
// @public (undocumented)
export type PCStreamPriorityObject = {
    engine: string;
    format: string;
};
...
// @public (undocumented)
export type PCTrackTypes = {
    [track: string]: string;
};

// @public (undocumented)
export type PCVideoDimensionsObject = {
    videoHeight: number;
    videoWidth: number;
};

// @public (undocumented)
export type PCVideoElementStore = {
...
export class Player extends FakeEventTarget {
    ...
    destroy(): void;
    detachMediaSource(): void;
    set dimensions(dimensions: PCDimensionsConfig);
    ...
    play(playOptions?: PCPlayOptionsObject): void;
    // Warning: (ae-forgotten-export) The symbol "PlaybackMiddleware" needs to be exported by the entry point playchi.d.ts
    ...
    get poster(): string;
    // Warning: (ae-forgotten-export) The symbol "PosterManager" needs to be exported by the entry point playchi.d.ts
    ...
    setSources(sources: PCSourcesConfigObject): void;
    setSourcesMetadata(sourcesMetadata: PCMetadataConfigObject): void;
    setTextDisplaySettings(settings: PCTextTrackDisplaySettingObject): void;
    showBlackCover(): void;
    showTextTrack(): void;
...
// Warning: (ae-forgotten-export) The symbol "EngineProvider" needs to be exported by the entry point playchi.d.ts
//
// @public (undocumented)
export const registerEngine: typeof EngineProvider.register;

// Warning: (ae-forgotten-export) The symbol "MediaSourceProvider" needs to be exported by the entry point playchi.d.ts
//
// @public (undocumented)
export const registerMediaSourceAdapter: typeof MediaSourceProvider.register;

// @public (undocumented)
export const RequestType: PCRequestType;
...
// @public (undocumented)
export const ScreenOrientationType: PCOrientationType;
...
export class TextStyle {
    ...
    // (undocumented)
    static fromJson(setting: PCTextStyleObject): TextStyle;
    // (undocumented)
    ...
    toCSS(): string;
    // (undocumented)
    static toJson(text: TextStyle): PCTextStyleObject;
    static toRGBA(color: [number, number, number], opacity: number): string;
}

// @public (undocumented)
class TextTrack_2 extends Track {
    // Warning: (ae-forgotten-export) The symbol "TrackSettings" needs to be exported by the entry point playchi.d.ts
...
export { TextTrack_2 as PCTextTrack }
...
//
// src/types/sources-config.ts:15:3 - (ae-forgotten-export) The symbol "PCExternalCaptionObject" needs to be exported by the entry point playchi.d.ts
// src/utils/util.ts:503:4 - (ae-forgotten-export) The symbol "jsonp" needs to be exported by the entry point playchi.d.ts
